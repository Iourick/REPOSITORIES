...
#include "../../ProgressBarThreadTest/mythread.h"
...
QT_MOC_LITERAL(5, 30, 12), // "calcfinished"
QT_MOC_LITERAL(6, 43, 6) // "result"

    },
    "MyThread\0progress\0\0step\0error\0"
    "calcfinished\0result"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->progress((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< double(*)>(_a[2]))); break;
        ...
        {
            using _t = void (MyThread::*)(int , double );
...
// SIGNAL 0
void MyThread::progress(int _t1, double _t2)
{
